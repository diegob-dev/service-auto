  ...
  return (
    <>
      ...
      <CallToAction
        ...
        title="Scopri come ci prendiamo cura della tua auto"
        subtitle="Metodo, competenza Volvo e un rapporto diretto in ogni fase dell'intervento."
        button="Scopri l'officina"
        buttonTo="/officina"
        icon={Wrench}
      />
    </>
